    ...
    return (
        <div className={Styles.majorContainer}>
            <div className={Styles.header}>
                <span className={Styles.dashhead}>Daily Progress</span>
                <span className={Styles.leaderboard}><b>5/50</b>in Leaderboard</span>
            </div>
            <div className={Styles.progressviewer}>
                <div className={Styles.num}>
                    <div id={Styles.burnt}>
                        <span>Total Calories burnt</span>
                        <h2>{calBurnt}</h2>
                    </div>
                    ...
                    <div id={Styles.consumed}>
                        <span>Total<br/>Calories Consumed</span>
                        <h2>{calConsumed}</h2>
                    </div>
                </div>
